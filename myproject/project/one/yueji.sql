SET NAMES UTF8;
DROP DATABASE IF EXISTS yueji;
CREATE DATABASE yueji CHARSET=UTF8;
USE yueji;
-- *零食家族*
CREATE TABLE yueji_snacks_family(
  fid INT PRIMARY KEY AUTO_INCREMENT,
  fname VARCHAR(32)
);

-- /**零食**/
CREATE TABLE yueji_snacks(
...
-- /**收货地址信息**/
CREATE TABLE yueji_receiver_address(
...
-- /**购物车条目**/
CREATE TABLE yueji_shoppingcart_item(
...
/**用户订单**/
CREATE TABLE yueji_order_detail(
...
--/****首页轮播广告商品****/
CREATE TABLE yueji_index_carousel
...
-- /****首页商品****/
CREATE TABLE yueji_index_product(
  pid INT PRIMARY KEY AUTO_INCREMENT,
  title VARCHAR(64),
  details VARCHAR(128),
  pic VARCHAR(128),
...
-- /*******************/
-- /**零食家族**/
INSERT INTO yueji_snacks_family VALUES
(NULL,'坚果炒货'),
(NULL,'肉食即食'),
(NULL,'果干'),
(NULL,'核桃'),
...
-- /**笔记本电脑**/
-- INSERT INTO yueji_laptop VALUES
...
-- /**笔记本电脑图片**/
-- INSERT INTO yueji_laptop_pic VALUES
...
-- /****首页轮播广告商品****/
INSERT INTO yueji_index_carousel VALUES
...
-- /****首页商品****/
-- INSERT INTO yueji_index_product VALUES
